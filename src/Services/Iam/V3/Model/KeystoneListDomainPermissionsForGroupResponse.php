...
class KeystoneListDomainPermissionsForGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneListDomainPermissionsForGroupResponse';
