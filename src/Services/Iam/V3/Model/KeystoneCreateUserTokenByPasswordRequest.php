...
class KeystoneCreateUserTokenByPasswordRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateUserTokenByPasswordRequest';
    ...
    */
    protected static $openAPITypes = [
            'nocatalog' => 'string',
            'body' => '\HuaweiCloud\SDK\Iam\V3\Model\KeystoneCreateUserTokenByPasswordRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\KeystoneCreateUserTokenByPasswordRequestBody|null $body body
    *
    * @return $this
    */
