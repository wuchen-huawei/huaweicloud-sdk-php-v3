...
class AssociateAgencyWithProjectPermissionRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateAgencyWithProjectPermissionRequest';
