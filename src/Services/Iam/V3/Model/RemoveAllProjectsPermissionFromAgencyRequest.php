...
class RemoveAllProjectsPermissionFromAgencyRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveAllProjectsPermissionFromAgencyRequest';
