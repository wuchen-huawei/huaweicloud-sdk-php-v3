...
class KeystoneUpdateIdentityProviderRequestBody implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneUpdateIdentityProviderRequestBody';
