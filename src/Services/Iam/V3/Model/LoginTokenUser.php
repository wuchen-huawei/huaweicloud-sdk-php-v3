...
class LoginTokenUser implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LoginTokenUser';
    ...
    */
    protected static $openAPITypes = [
            'domain' => '\HuaweiCloud\SDK\Iam\V3\Model\LoginTokenDomain',
            'name' => 'string',
    ...
    * Gets domain
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\LoginTokenDomain|null
    */
    ...
    * Sets domain
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\LoginTokenDomain|null $domain domain
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 被委托方用户名。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $passwordExpiresAt 被委托方用户的密码过期时间。
    *
    * @return $this
    */
