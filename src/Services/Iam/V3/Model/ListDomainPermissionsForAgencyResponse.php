...
class ListDomainPermissionsForAgencyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainPermissionsForAgencyResponse';
