...
class KeystoneCreateIdentityProviderResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateIdentityProviderResponse';
