    ...
    */
    public function setDurationSeconds($durationSeconds)
    {
            ...
            if (!is_null($durationSeconds) && ($durationSeconds > 86400)) {
                throw new \InvalidArgumentException('invalid value for $durationSeconds when calling IdentityAssumerole., must be smaller than or equal to 86400.');
            }
            if (!is_null($durationSeconds) && ($durationSeconds < 900)) {
                throw new \InvalidArgumentException('invalid value for $durationSeconds when calling IdentityAssumerole., must be bigger than or equal to 900.');
            }
