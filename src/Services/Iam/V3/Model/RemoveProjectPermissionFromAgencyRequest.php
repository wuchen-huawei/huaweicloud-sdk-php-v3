...
class RemoveProjectPermissionFromAgencyRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveProjectPermissionFromAgencyRequest';
