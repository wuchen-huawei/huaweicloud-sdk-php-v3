...
class KeystoneCreateScopedTokenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateScopedTokenResponse';
    ...
    */
    protected static $openAPITypes = [
            'token' => '\HuaweiCloud\SDK\Iam\V3\Model\ScopeTokenResult',
    ...
    * Gets token
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\ScopeTokenResult|null
    */
    ...
    * Sets token
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\ScopeTokenResult|null $token token
    *
    * @return $this
    */
