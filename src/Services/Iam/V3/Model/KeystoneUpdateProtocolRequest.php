...
class KeystoneUpdateProtocolRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneUpdateProtocolRequest';
    ...
    */
    protected static $openAPITypes = [
            'idpId' => 'string',
            'protocolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Iam\V3\Model\KeystoneUpdateProtocolRequestBody'
    ];
    ...
    * Gets body
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\KeystoneUpdateProtocolRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\KeystoneUpdateProtocolRequestBody|null $body body
    *
    * @return $this
    */
