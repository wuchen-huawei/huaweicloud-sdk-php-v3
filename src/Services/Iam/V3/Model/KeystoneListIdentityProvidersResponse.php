...
class KeystoneListIdentityProvidersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneListIdentityProvidersResponse';
    ...
    */
    protected static $openAPITypes = [
            'identityProviders' => '\HuaweiCloud\SDK\Iam\V3\Model\IdentityprovidersResult[]',
    ...
    */
    ...
    {
        $this->container['identityProviders'] = isset($data['identityProviders']) ? $data['identityProviders'] : null;
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\IdentityprovidersResult[]|null $identityProviders 身份提供商信息列表。
    *
    * @return $this
    */
