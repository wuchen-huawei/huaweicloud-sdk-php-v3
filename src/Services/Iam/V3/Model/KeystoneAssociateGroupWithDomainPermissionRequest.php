...
class KeystoneAssociateGroupWithDomainPermissionRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneAssociateGroupWithDomainPermissionRequest';
