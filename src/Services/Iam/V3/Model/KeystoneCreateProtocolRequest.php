...
class KeystoneCreateProtocolRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateProtocolRequest';
    ...
    */
    protected static $openAPITypes = [
            'idpId' => 'string',
            'protocolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Iam\V3\Model\KeystoneCreateProtocolRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\KeystoneCreateProtocolRequestBody|null $body body
    *
    * @return $this
    */
