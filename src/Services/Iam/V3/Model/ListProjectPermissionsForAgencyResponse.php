...
class ListProjectPermissionsForAgencyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectPermissionsForAgencyResponse';
