...
class LoginTokenAuth implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LoginTokenAuth';
    ...
    */
    protected static $openAPITypes = [
            'securitytoken' => '\HuaweiCloud\SDK\Iam\V3\Model\LoginTokenSecurityToken'
    ];
    ...
    * Sets securitytoken
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\LoginTokenSecurityToken $securitytoken securitytoken
    *
    * @return $this
    */
