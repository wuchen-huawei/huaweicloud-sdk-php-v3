...
class KeystoneCreateUserTokenByPasswordAndMfaResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateUserTokenByPasswordAndMfaResponse';
