...
class SecurityCompliance implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityCompliance';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['passwordRegex'] === null) {
            $invalidProperties[] = "'passwordRegex' can't be null";
        }
        if ($this->container['passwordRegexDescription'] === null) {
            $invalidProperties[] = "'passwordRegexDescription' can't be null";
        }
    ...
    * Sets passwordRegex
    *
    * @param string $passwordRegex 密码强度策略的正则表达式。
    *
    * @return $this
    */
    ...
    *
    * @param string $passwordRegexDescription 密码强度策略的描述。
    *
    * @return $this
    */
