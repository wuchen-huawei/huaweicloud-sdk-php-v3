...
class CreateUnscopeTokenByIdpInitiatedResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateUnscopeTokenByIdpInitiatedResponse';
    ...
    */
    protected static $openAPITypes = [
            'token' => '\HuaweiCloud\SDK\Iam\V3\Model\IdpToken',
    ...
    * Gets token
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\IdpToken|null
    */
    ...
    * Sets token
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\IdpToken|null $token token
    *
    * @return $this
    */
