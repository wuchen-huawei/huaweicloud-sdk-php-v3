...
class KeystoneUpdateIdentityProviderResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneUpdateIdentityProviderResponse';
    ...
    */
    protected static $openAPITypes = [
            'identityProvider' => '\HuaweiCloud\SDK\Iam\V3\Model\IdentityprovidersResult'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\IdentityprovidersResult|null $identityProvider identityProvider
    *
    * @return $this
    */
