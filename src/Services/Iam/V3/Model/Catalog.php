...
class Catalog implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'endpoints' => '\HuaweiCloud\SDK\Iam\V3\Model\CatalogEndpoints[]',
            'id' => 'string',
            'name' => 'string',
            'type' => 'string'
    ];
    ...
    * Gets endpoints
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\CatalogEndpoints[]
    */
    ...
    * Sets endpoints
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\CatalogEndpoints[] $endpoints 终端节点信息。
    *
    * @return $this
    */
