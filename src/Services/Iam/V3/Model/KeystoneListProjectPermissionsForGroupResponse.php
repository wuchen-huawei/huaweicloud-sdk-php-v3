...
class KeystoneListProjectPermissionsForGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneListProjectPermissionsForGroupResponse';
