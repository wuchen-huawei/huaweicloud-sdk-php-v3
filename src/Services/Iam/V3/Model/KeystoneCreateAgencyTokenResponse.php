...
class KeystoneCreateAgencyTokenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateAgencyTokenResponse';
    ...
    */
    protected static $openAPITypes = [
            'token' => '\HuaweiCloud\SDK\Iam\V3\Model\AgencyTokenResult',
    ...
    * Gets token
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\AgencyTokenResult|null
    */
    ...
    * Sets token
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\AgencyTokenResult|null $token token
    *
    * @return $this
    */
