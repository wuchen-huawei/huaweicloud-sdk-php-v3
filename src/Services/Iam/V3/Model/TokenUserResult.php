...
class TokenUserResult implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TokenUserResult';
    ...
    */
    protected static $openAPITypes = [
            ...
            'domain' => '\HuaweiCloud\SDK\Iam\V3\Model\TokenUserDomainResult'
    ];
    ...
    * Gets domain
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\TokenUserDomainResult
    */
    ...
    * Sets domain
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\TokenUserDomainResult $domain domain
    *
    * @return $this
    */
