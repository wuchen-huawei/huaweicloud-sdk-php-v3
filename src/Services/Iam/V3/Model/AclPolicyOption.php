...
class AclPolicyOption implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\AllowAddressNetmasksOption[] $allowAddressNetmasks 允许访问的IP地址或网段。
    *
    * @return $this
    */
    ...
    * Sets allowIpRanges
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\AllowIpRangesOption[] $allowIpRanges 允许访问的IP地址区间
    *
    * @return $this
    */
