...
class KeystoneCreateIdentityProviderRequestBody implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeystoneCreateIdentityProviderRequestBody';
