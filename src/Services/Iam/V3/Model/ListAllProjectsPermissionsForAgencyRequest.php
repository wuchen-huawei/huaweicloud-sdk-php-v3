...
class ListAllProjectsPermissionsForAgencyRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllProjectsPermissionsForAgencyRequest';
