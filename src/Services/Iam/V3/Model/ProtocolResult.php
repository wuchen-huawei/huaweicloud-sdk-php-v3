...
class ProtocolResult implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProtocolResult';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'mappingId' => 'string',
            'links' => '\HuaweiCloud\SDK\Iam\V3\Model\ProtocolLinks'
    ];
    ...
    * Sets links
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\ProtocolLinks $links links
    *
    * @return $this
    */
