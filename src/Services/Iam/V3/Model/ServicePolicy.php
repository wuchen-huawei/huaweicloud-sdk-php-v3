...
class ServicePolicy implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServicePolicy';
    ...
    */
    protected static $openAPITypes = [
            'version' => 'string',
            'statement' => '\HuaweiCloud\SDK\Iam\V3\Model\ServiceStatement[]'
    ];
