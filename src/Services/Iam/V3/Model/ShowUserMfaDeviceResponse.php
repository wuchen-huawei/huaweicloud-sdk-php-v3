...
class ShowUserMfaDeviceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUserMfaDeviceResponse';
    ...
    */
    protected static $openAPITypes = [
            'virtualMfaDevice' => '\HuaweiCloud\SDK\Iam\V3\Model\MfaDeviceResult'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\MfaDeviceResult|null $virtualMfaDevice virtualMfaDevice
    *
    * @return $this
    */
