...
class RemoveDomainPermissionFromAgencyRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveDomainPermissionFromAgencyRequest';
