...
class AssociateAgencyWithDomainPermissionRequest implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateAgencyWithDomainPermissionRequest';
